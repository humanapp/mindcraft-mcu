 ...
 * singleton display struct and `buttonA` to a button struct discriminated by
 * its field id; any other field reads nil. Mirrors the MicroBit field getter
 * installed by the microbit-v2 module.
 */
