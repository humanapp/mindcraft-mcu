...
/** Wendoo integration metadata for a WODAL device profile. */
export interface WodalDeviceProfile {
  ...
  /** Creates the Wendoo module for this profile. */
  readonly createWendooModule: () => WendooModule;
...
/**
 * Returns Wendoo integration metadata for a supported WODAL device profile.
 *
