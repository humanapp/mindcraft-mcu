...
/** Matches any event source or value in a microbit message bus listener. */
export const MICROBIT_EVT_ANY = WODAL_EVT_ANY;

/** Matches any event source in a microbit message bus listener. */
...
/** Gesture value reported when no microbit accelerometer gesture has been recognized. */
