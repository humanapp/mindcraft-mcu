 ...
 */
function buildBrainDef(env: MindcraftEnvironment, childCount: number): BrainDef {
...
function buildImage(env: MindcraftEnvironment, childCount: number): WodalProgramImage<LinkedBrainProgram> {
