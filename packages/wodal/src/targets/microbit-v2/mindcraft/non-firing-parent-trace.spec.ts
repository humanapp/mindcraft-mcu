...
/** Runs the committed binary over the fixed tick schedule with the display taps installed. */
function runTrace(bin: Uint8Array, tickCount: number): string {
  ...
  for (const actionId of [MicroBitV2HostActions.ButtonA.actionId, MicroBitV2HostActions.DisplaySetPixel.actionId]) {
