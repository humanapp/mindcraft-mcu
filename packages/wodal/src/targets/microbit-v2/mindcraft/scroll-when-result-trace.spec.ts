...
import { CoreTypeIds, type IBrainTileDef, type MindcraftEnvironment, mkActuatorTileId } from "@mindcraft-lang/core/app";
...
interface Variant {
  base: string;
  makeWhenTile: (env: MindcraftEnvironment) => IBrainTileDef;
  expectedText: string;
}
 ...
 */
function buildBrainDef(env: MindcraftEnvironment, variant: Variant): BrainDef {
...
function buildImage(env: MindcraftEnvironment, variant: Variant): WodalProgramImage<LinkedBrainProgram> {
