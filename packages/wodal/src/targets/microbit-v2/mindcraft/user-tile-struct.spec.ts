...
const PACKET_WRITE_SOURCE = `import { Actuator, param, type Context } from "mindcraft";
import { Position } from "./position";
...
const NUMBER_WRITE_SOURCE = `import { Actuator, param, type Context } from "mindcraft";
