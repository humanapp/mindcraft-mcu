...
const MICROBIT_V2_LIB_COORDINATE = "mindcraft-lang/lib-microbit-v2";

/** The micro:bit v2 image library dependency: `@lib/mindcraft-lang/lib-microbit-v2` resolves to its entry module. */
function wodalStdlibDependencies(): readonly ProjectDependency[] {
  return [{ coordinate: MICROBIT_V2_LIB_COORDINATE }];
}

/** The micro:bit v2 image library content, mounted read-only for `@lib/mindcraft-lang/lib-microbit-v2` resolution. */
...
import { image, heart } from "@lib/mindcraft-lang/lib-microbit-v2";
