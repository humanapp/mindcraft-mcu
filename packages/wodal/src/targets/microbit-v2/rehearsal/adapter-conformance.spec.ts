...
import { ScenarioRejection, ScenarioRejectionCode } from "@wendoo/assistant-bridge/kit";
...
import { mkActuatorTileId, mkParameterTileId, mkSensorTileId } from "@wendoo/core/app";
