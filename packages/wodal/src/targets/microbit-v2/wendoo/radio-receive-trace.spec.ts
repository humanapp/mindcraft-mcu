...
import { type HostActionIds, mkActuatorTileId, mkSensorTileId, type WendooEnvironment } from "@wendoo-lang/core/app";
...
/** Runs a fixture binary over its injected-packet schedule with the trace observers installed. */
