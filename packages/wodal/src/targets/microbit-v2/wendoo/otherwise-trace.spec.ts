...
function buildBrainDef(env: WendooEnvironment, name: string, pages: readonly (readonly RuleSpec[])[]): BrainDef {
 ...
 */
function buildParkedSubjectBrain(env: WendooEnvironment): BrainDef {
  const tiles = env.brainServices.edit.tiles;
