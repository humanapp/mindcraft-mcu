...
import { CoreFuncId, CoreTypeIds, type LinkedBrainProgram, linkedBrainProgramToJson, Op } from "@wendoo/core/runtime";
...
function reporterSource(name: string, pin: number): string {
  return `import { Actuator, param, type Context } from "wendoo";
