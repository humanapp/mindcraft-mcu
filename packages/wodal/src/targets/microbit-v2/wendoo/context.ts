...
/** Runtime context data required by the WODAL Wendoo module. */
...
/**
 * Reads the WODAL device from a Wendoo execution context.
 *
 * @param ctx - Wendoo execution context.
 ...
 *
 * @param ctx - Wendoo execution context the call runs in.
