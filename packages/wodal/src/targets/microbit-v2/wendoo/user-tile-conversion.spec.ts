...
import { CoreTypeIds, type LinkedBrainProgram, linkedBrainProgramToJson } from "@wendoo-lang/core/runtime";
...
const CONVERSION_SOURCE = `import { BufferType, Conversion, NumberType } from "wendoo";
...
const ACTUATOR_SOURCE = `import { Actuator, param, type Context } from "wendoo";
