...
import { type WodalProgramLoadValidation, WodalProgramLoadValidationCode } from "../../../wendoo/program-load";
...
export interface WodalMicroBitRuntimeOptions {
  /** Wendoo environment with core and microbit-v2 modules installed. */
...
/**
 * WODAL runtime facade for executing one loaded Wendoo brain against a scoped simulated device.
 */
...
function createHostServices(environment: WendooEnvironment): Omit<PlatformServices, "brain"> {
