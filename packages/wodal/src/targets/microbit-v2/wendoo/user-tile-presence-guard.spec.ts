...
const SENSOR_SOURCE = `import { Sensor, type Context, optional, param } from "wendoo";
...
/** Runs the committed binary over the schedule with the trace observers and radio-send tap installed. */
