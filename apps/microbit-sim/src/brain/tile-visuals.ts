...
export const tileVisuals = new Map<string, Partial<TileVisual>>([
  // Operators
  [mkOperatorTileId(CoreOpId.And), { label: "AND", iconUrl: icon("op-and") }],
  [mkOperatorTileId(CoreOpId.Or), { label: "OR", iconUrl: icon("op-or") }],
  [mkOperatorTileId(CoreOpId.Not), { label: "NOT", iconUrl: icon("op-not") }],
  [mkOperatorTileId(CoreOpId.Add), { label: "plus", iconUrl: icon("op-add") }],
  [mkOperatorTileId(CoreOpId.Subtract), { label: "minus", iconUrl: icon("op-subtract") }],
  [mkOperatorTileId(CoreOpId.Multiply), { label: "multiplied by", iconUrl: icon("op-multiply") }],
  [mkOperatorTileId(CoreOpId.Divide), { label: "divided by", iconUrl: icon("op-divide") }],
  [mkOperatorTileId(CoreOpId.Negate), { label: "negative", iconUrl: icon("op-negate") }],
  [mkOperatorTileId(CoreOpId.EqualTo), { label: "equal to", iconUrl: icon("op-equal-to") }],
  [mkOperatorTileId(CoreOpId.NotEqualTo), { label: "not equal to", iconUrl: icon("op-not-equal-to") }],
  [mkOperatorTileId(CoreOpId.LessThan), { label: "less than", iconUrl: icon("op-less-than") }],
  [mkOperatorTileId(CoreOpId.LessThanOrEqualTo), { label: "less than or equal to", iconUrl: icon("op-less-than-or-equal-to") }],
  [mkOperatorTileId(CoreOpId.GreaterThan), { label: "greater than", iconUrl: icon("op-greater-than") }],
  [mkOperatorTileId(CoreOpId.GreaterThanOrEqualTo), { label: "greater than or equal to", iconUrl: icon("op-greater-than-or-equal-to") }],
  [mkOperatorTileId(CoreOpId.Assign), { label: "gets", iconUrl: icon("op-assign") }],
  // Control Flow
  [mkControlFlowTileId(CoreControlFlowId.OpenParen), { label: "(", iconUrl: icon("cf-open-paren") }],
  [mkControlFlowTileId(CoreControlFlowId.CloseParen), { label: ")", iconUrl: icon("cf-close-paren") }],
  // Variable Factories
  ...
  [mkSensorTileId(CoreHostActions.CurrentPage.key), { label: "current page", iconUrl: icon("sensor-current-page") }],
  [mkSensorTileId(CoreHostActions.PreviousPage.key), { label: "previous page", iconUrl: icon("sensor-previous-page") }],
